...
class MLP :
    ...
    *hidden_size # Number of perceptron in any layer
    ...
    def gradient(self,x:np.ndarray,y:np.ndarray) :
        ...
        # Caclulating the backpropagation for the outhermost layer!
        #region
        ...
        # End of Calculation for the outhermost layer
        #endregion
    ...
    def fit(self,x:np.ndarray,y:np.ndarray,learning_rate:float=0.01,epoches:int=10) :
        '''
        '''
